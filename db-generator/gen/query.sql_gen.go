...
func (q *Queries) CreateSections(ctx context.Context, arg CreateSectionsParams) (sql.NullString, error) {
...
func (q *Queries) DeleteSections(ctx context.Context, sectTitle sql.NullString) error {
...
// Sections
func (q *Queries) GetSections(ctx context.Context, sectTitle sql.NullString) (CurriculumSection, error) {
